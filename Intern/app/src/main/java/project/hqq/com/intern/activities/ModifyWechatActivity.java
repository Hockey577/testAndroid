...
public class ModifyWechatActivity extends BaseActivity implements View.OnClickListener {
            ...
            switch (msg.what) {
                case Constant.CONSTANT105:
                    ...
                    if(bean.getResultMessage().equals("修改成功")){
                        ...
                        intent.putExtra(Constant.KEY_WECHAT,et_wechat.getText().toString());
                        setResult(Constant.RESULT_CODE_WECHAT,intent);
                        finish();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.im_back:
                ...
                break;
            case R.id.tv_finish:
                editWechatRequest(id);
                break;
        }

    }
    private void editWechatRequest(int id){
        Map<String,Object> map=new HashMap<>();
        map.put("id",id);
        map.put("weChat",et_wechat.getText().toString());
